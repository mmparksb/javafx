...
//            this.endRow = this.totalCount;
//            this.pageSize = this.endRow - this.beginRow + 1;
//        } else {
...
//
//
//        this.beginPage = this.pageNumber / this.pageCount * this.pageCount + 1;
//
//        if (this.pageNumber / this.pageCount == this.totalPage / this.pageCount
//                &&
//                this.pageNumber != this.totalPage) {
//            // 마지막 페이지 라인을 보여주고, 내가 선택한 페이지가 마지막 페이지가 아닐 때
//            this.endPage = this.totalPage;
//            this.pageCount = this.totalPage % this.pageCount;
//        } else {
//            this.endPage = this.beginPage + this.pageCount - 1;
//        }
//
//        if (this.pageNumber == this.totalPage) { // 마지막 페이지를 보고 싶을 때
//            this.endPage = this.totalPage;
//            this.beginPage = this.endPage - this.pageCount + 1;
//            this.pageCount = this.endPage - this.beginPage + 1;
//        }
//    }
/*
저작권 ㅋㅋㅋㅋ
...
//        if (this.pageNumber / 10 == this.totalPage / 10) {
//            if (this.pageNumber == this.totalPage) {
//                this.beginRow = this.pageNumber * this.pageSize + 1 ;
//                this.endRow = totalCount;
//                this.pageSize = this.endRow - this.beginRow + 1 ;
//            } else {
//                this.beginRow = this.pageNumber * 10 -9;
//                this.endRow = this.pageNumber * 10 ;
//            }
//            this.pageCount = this.totalPage - (this.pageNumber/10) * 10;
//            this.beginPage = (this.pageNumber / 10) * 10 + 1;
//            this.endPage = this.totalPage;
//        } else {
//            this.beginRow = this.pageNumber * 10 -9;
//            this.endRow = this.pageNumber * 10 ;
